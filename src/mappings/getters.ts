...
import { UniswapFactory, Bundle, Pair, Token, Burn } from '../../generated/schema'
import {
  FACTORY_ADDRESS,
  ZERO_BD,
  ZERO_BI,
...
export function getOrCreatePair(pairAddr: Address, blockTimestamp?: BigInt, blockNumber?: BigInt): Pair {
  ...
  if (pair === null) {
    ...
    pair.createdAtTimestamp = blockTimestamp || ZERO_BI
    pair.createdAtBlockNumber = blockNumber || ZERO_BI
